...
import CallRecorderBlockerImage2x from 'public/images/mobile/landings/setupFlow/features/call-recorder-blocker@2x.webp';
...
export const CallRecorderBlockerFeatureConfig = {
    ...
    image: {
        default: CallRecorderBlockerImage,
        retina: CallRecorderBlockerImage2x
    },
