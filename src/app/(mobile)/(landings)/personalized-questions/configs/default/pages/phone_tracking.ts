...
const PageContent = 'Who do you think is tracking your phone?';

export const PhoneTrackingConfig: IPageContentConfig = {
    id: PersonalizedQuestionsPages.PhoneTracking,
                    ...
                    children: [
                        {
                            ...
                            title: {
                                default: 'Who do you think is',
                                highlighted: ' \n tracking ',
                                defaultAdd: 'your phone?'
                            },
                        },
                        {
                            id: 'content',
                            ...
                            children: [
                                {
                                    ...
                                    answersConfig: [
                                        {
                                            label: 'Ex',
                                            id: `${PersonalizedQuestionsPages.PhoneTracking}_ex`,
                                        },
                                        {
                                            label: 'Spouse',
                                            id: `${PersonalizedQuestionsPages.PhoneTracking}_spouse`,
                                        },
                                        {
                                            label: 'Friend',
                                            id: `${PersonalizedQuestionsPages.PhoneTracking}_friend`,
                                        },
                                        {
                                            label: 'Cybercriminals',
                                            id: `${PersonalizedQuestionsPages.PhoneTracking}_cybercriminals`,
                                            skipNextPageId: true,
                                        },
                                        {
                                            label: 'Big corporations',
                                            id: `${PersonalizedQuestionsPages.PhoneTracking}_big-corporations`,
                                            skipNextPageId: true,
                                        },
                                    ]
                                },
